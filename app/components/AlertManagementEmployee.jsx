...
import { Bell, X, Calendar, AlertTriangle, Car, User } from "lucide-react";

const AlertManagementEmployee = () => {
  ...
  const getAlerts = async () => {
    try {
      const response = await axios.get("/api/employee/getAlertsByEmail");
    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-8 lg:p-10 max-w-7xl mx-auto w-full">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 border-b border-gray-200 pb-6 mb-8">
          <div>
            <h1 className="text-3xl font-extrabold text-gray-900 tracking-tight">Alert Center</h1>
            <p className="text-sm text-gray-500 mt-2">View notifications, warnings, and maintenance alerts assigned to you.</p>
          </div>
          <button 
        ...
        {/* Empty state */}
        {alerts && (!Array.isArray(alerts) || alerts.length === 0) && !isLoading && (
          <div className="text-center py-12 bg-white border border-gray-200 rounded-2xl shadow-sm">
            <Bell className="w-12 h-12 text-gray-300 mx-auto mb-3" />
            <p className="text-gray-500 text-sm font-medium">No alerts registered for your account.</p>
          </div>
        )}
                      ...
                      <div className="space-y-2 text-xs text-gray-600 mb-4">
                        ...
                        <div className="flex items-center gap-2 bg-gray-50 border border-gray-100 p-2 rounded-xl">
                          ...
                          <div className="min-w-0 flex-1">
                            <p className="text-[9px] uppercase font-bold text-gray-400 leading-none">Employee Assigned</p>
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-2xl max-w-md w-full overflow-hidden flex flex-col animate-in fade-in zoom-in-95 duration-200">
              ...
              <form onSubmit={handleSubmit(createAlertMutation.mutate)} className="p-6 space-y-4">
                ...
                <div>
                  ...
                  {errors.employee && <p className="text-rose-500 text-[10px] mt-0.5">{errors.employee.message}</p>}
                </div>
...
export default AlertManagementEmployee;